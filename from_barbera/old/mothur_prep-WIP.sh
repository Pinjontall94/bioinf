...
#      these are the "groups" previously mentioned (e.g. SRR123456_1.fastq and SRR123456_2.fastq
...
for i in $(ls -l | grep -Eo $fileRegex); do                                                    
	...
	U=$(echo "$i" | sed 's/_[1-2]\.fastq.*//g' | sed 's/\.fastq*//g') # Unique Identifier
	echo "U = $U"
